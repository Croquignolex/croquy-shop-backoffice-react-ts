...
import useCouponAddHook, {
    BrandAddHookType,
    BrandAddFormType,
    brandAddSchema,
    brandAddInitialStaticValues
} from "../hooks/useCouponAddHook";

const CouponAddForm: FC<BrandAddFormProps> = ({added, finished}): ReactElement => {
    ...
    const {
        ...
        sequence,
        isAddBrandPending
    }: BrandAddHookType = useCouponAddHook({added, finished});
