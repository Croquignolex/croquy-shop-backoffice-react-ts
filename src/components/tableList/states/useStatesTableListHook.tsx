...
import {
    defaultStatesResponseData, DestroyStateRequestDataType,
    StatesHookType, StatesResponseDataType, statesRequest, StatesHookProps
} from "../../../pages/states/statesData";

const useStatesTableListHook = ({fetchStates, statesBaseUrl}: StatesHookProps): StatesHookType => {
